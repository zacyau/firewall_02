...
class H3CFirewallAdapter(FirewallAdapter):
    """新华三防火墙适配器"""
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            print(f"连接新华三防火墙 {self.name} 失败: {e}")
            return False
    ...
    def check_heartbeat(self) -> Dict[str, Any]:
        ...
        try:
            ...
            stdin, stdout, stderr = self.client.exec_command("display device manuinfo")
    ...
    def generate_cli_command(self, policy_config: Dict[str, Any]) -> str:
        """生成新华三防火墙CLI命令"""
        return self._render_template("h3c_policy.j2", policy_config)

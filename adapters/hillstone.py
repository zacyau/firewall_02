...
class HillstoneFirewallAdapter(FirewallAdapter):
    """山石防火墙适配器"""
    ...
    def connect(self) -> bool:
        ...
        try:
            ...
            print(f"连接山石防火墙 {self.name} 失败: {e}")
            return False
    ...
    def check_heartbeat(self) -> Dict[str, Any]:
        ...
        try:
            ...
            stdin, stdout, stderr = self.client.exec_command("show system info")
    ...
    def generate_cli_command(self, policy_config: Dict[str, Any]) -> str:
        """生成山石防火墙CLI命令"""
        return self._render_template("hillstone_policy.j2", policy_config)
